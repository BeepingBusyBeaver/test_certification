...
python patch_bvh_all.py ./data/BVH/input.bvh --frames 2000 4250 --std1 0.05 --std2 0.10 --pelvis_csv_01 ./data/result/position_vector_01.csv --pelvis_csv_02 ./data/result/position_vector_02.csv --pelvis_csv_03 ./data/result/position_vector_03.csv --Hips --Chest --RightCollar --RightShoulder --RightElbow --RightWrist

python endSite.py ./data/BVH/input_patched.bvh
python L2distance_with_csv.py ./data/BVH/input.bvh --frames 2000 4250
python L2distance_with_csv.py ./data/BVH/input_patched.bvh --frames 2000 4250
python visualization.py --midsphere --frames 2000 4250 --input_bvh ./data/BVH/input.bvh --patched_bvh ./data/BVH/input_patched.bvh
pause